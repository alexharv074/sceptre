...
class TestCli(object):
    ...
    @pytest.mark.parametrize("command,files,output", [
        ...
        (
            ...
            {
                "common.yaml": {"CommonTags": {"Organization": "Parts Unlimited", "Department": "IT Operations"}},
                "dev.yaml": {"CommonTags": {"Environment": "dev"}}
            },
            {
                "CommonTags": {"Organization": "Parts Unlimited", "Department": "IT Operations", "Environment": "dev"}
            }
        ),
        ...
        (
            ["--merge-keys", "--var-file", "common.yaml", "--var-file", "dev.yaml", "noop"],
            {
                "common.yaml": {"CommonTags": {"Organization": "Parts Unlimited", "Department": "IT Operations", "Environment": "sandbox"}},
                "dev.yaml": {"CommonTags": {"Environment": "dev"}},
            },
            {
                "CommonTags": {"Organization": "Parts Unlimited", "Department": "IT Operations", "Environment": "dev"}
        ...
        (
            ...
            {
                "common.yaml": {"CommonTags": {"Organization": "Parts Unlimited", "Department": "IT Operations", "Envlist": ["sandbox", "dev"]}},
                "test.yaml": {"CommonTags": {"Envlist": ["test"]}},
            },
            {
                "CommonTags": {"Organization": "Parts Unlimited", "Department": "IT Operations", "Envlist": ["test"]} # May not be what we ultimately want!
            }
        ),
